...
### Fixed
- CI: run `npm run test:ci` instead of `npm test` — the default test script
  runs jest in watch mode, which hangs forever on GitHub Actions runners
...
[1.8.0]: https://github.com/gizmodata/grafana-gizmosql-datasource/releases/tag/v1.8.0
